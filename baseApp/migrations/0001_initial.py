    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subpdo_id', models.CharField(blank=True, max_length=25, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_freq', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='project_year', to='baseApp.collectionfrequency')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('project_years', models.ManyToManyField(blank=True, related_name='projects', to='baseApp.projectyear')),
